...
export default function BookingPage({ token, user, onBack }: any) {
  ...
  if (success) return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="bg-white rounded-2xl shadow-xl p-12 text-center max-w-md">
        ...
        <p className="text-gray-500 mb-6">Your booking is pending approval from the business.</p>
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Notes */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
          <h2 className="font-semibold text-gray-800 mb-4">4. Additional Notes (optional)</h2>
          <textarea
